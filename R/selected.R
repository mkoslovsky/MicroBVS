...
selected <- function( dtm_obj = NULL, threshold = c( 0.5 ), plotting = FALSE, burnin = 0, cov_lab = NULL, edge_lab = NULL ){
  ...
  return( list( selected_zeta = selected_zeta, mppi_zeta = zeta_means, selected_name = selected_name) )
}
